...
variable "cluster_name" {
  description = "EKS cluster name (used to scope IAM permissions to this cluster's node groups)."
  type        = string
}
...
variable "service_account_namespace" {
  description = "Kubernetes namespace where the cluster-autoscaler ServiceAccount lives."
  type        = string
  default     = "kube-system"
}
